...
func (b *BlockChain) checkMerkleRootsContext(block *wire.MsgBlock, prevNode *blockNode) error {
	// Otherwise, the merkle roots were validated to match one of the
	// possibilities.  Ensure they actually match the correct algorithm now that
	// the full context is available to determine the agenda status.
